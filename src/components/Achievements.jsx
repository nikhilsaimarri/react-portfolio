...
const achievements = [
  ...
  },
  {
    ...
    description: 'Masterfully solveing problems, showcasing adept problem-solving skills.',
    url: 'https://leetcode.com/u/nikhilmarri9872/', // LeetCode profile URL
    additionalLinks: [
      { name: 'LeetCode', url: 'https://leetcode.com/u/nikhilmarri9872/' },
      { name: 'GeeksforGeeks', url: 'https://www.geeksforgeeks.org/user/nikhilmarri9872/' }
    ],
