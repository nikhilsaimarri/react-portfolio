        ...
        <div className="flex flex-col items-center md:space-x-12">
          <div className="flex-1">
            <p className="text-lg mb-8 text-justify">
              I am graduated with Master of Science in Cybersecurity(Computer Science) at the University of Central Missouri
              with a GPA of 3.54/4.0. I have over 3+ years of full-time experience as a Software Engineer at Myatlas, Wipro and
            ...
            <div className="flex justify-center items-center space-x-6 my-8">
              ...
              <a href="https://github.com/nikhilsaimarri" target="_blank" rel="noopener noreferrer"
                className="transform transition-transform duration-300 hover:scale-105">
