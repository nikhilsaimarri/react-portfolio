...
import {  SiMysql, SiSpringboot, SiCplusplus, SiC } from 'react-icons/si';
...
const skills = [
  { id: 1, name: "Python", icon: <FaPython size={40} />, proficiency: 80},
  { id: 2, name: "Java", icon: <FaJava size={40} />, proficiency: 90 },
  ...
  { id: 11, name: "Spring Boot", icon: <SiSpringboot size={40} />, proficiency: 80 },
  { id: 12, name: "C", icon: <SiC size={40} />, proficiency: 80 },
  { id: 13, name: "C++", icon: <SiCplusplus size={40} />, proficiency: 65 },
